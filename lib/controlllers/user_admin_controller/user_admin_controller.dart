...
import 'package:kasiradmin/models/user_admin_model.dart';
import 'dart:convert';
...
class UserAdminController extends GetxController {
  ...
  var currentUser = Rxn<UserAdminModel>();
  ...
  Future<void> loadUserFromPreferences() async {
    ...
    if (userData != null) {
      ...
      currentUser.value = UserAdminModel.fromJson(json.decode(userData));
    }
  }

  Future<void> saveUserToPreferences(UserAdminModel user) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future<void> register() async {
    ...
    final response = await http.post(
      Uri.parse('http://10.10.10.129/flutterapi/api_admin.php'),
      body: {
        'action': 'register',
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success') {
          ...
          // UserAdminModel user = UserAdminModel.fromJson(data['user']);
